...
?>
<div>
<tr><td> No Registrasi</td><td><input type='text' name='no_registrasi' value='<?echo $_SESSION[id_registrasi];?>' disabled></td></tr> 
...
<tr><td>Ganti File Lampiran</td><td><input type='file' name='lampiran'></td></tr> 
